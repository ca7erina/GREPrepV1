...
import dao.jdbc.JdbcMathDao;
import entity.Math;



public class MathAddFrame extends JFrame{
	private JLabel id = new JLabel();
	private JLabel message=new JLabel();
	private JTextArea questionArea;
	private JTextArea answerArea;
	private JTextArea pictureArea;
		...
		submit.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if (checkField()==false){
						Math a= new Math();
						a.setPicture(pictureArea.getText());
...
//		System.out.println(answerInfoArea.getText());
		if (frequenceField.getText().equals("")||pictureArea.getText()==null||questionArea.getText()==null||answerArea.getText()==null||answerInfoArea.getText()==null||catagoryField.getText().equals("")||historyDateField.getText().equals("")){
...
//			System.out.println(stop);
	...
	public JPanel createCenterPanel() {
		...
		JLabel label=new JLabel(" Add a new math here:");
		panel.add(label);
	...
	public JPanel createPicturePanel() {
		...
		pictureArea = new JTextArea(1,20);
		pictureArea.setLineWrap(true);
		pictureArea.setWrapStyleWord(true);
		pictureArea.setText("null");
		areaScrollPane = new JScrollPane(pictureArea);
		areaScrollPane.setVerticalScrollBarPolicy(  JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
		areaScrollPane.setPreferredSize(new Dimension(20,20));
		panel.add(BorderLayout.NORTH,label);
		panel.add(BorderLayout.CENTER,areaScrollPane);
	...
	public static void main(String[] args) {
		...
		MathAddFrame add = new MathAddFrame();
		add.setVisible(true);
	}
